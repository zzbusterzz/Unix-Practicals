...
//  listRH.Add (staticRh, 5);
  ...
  AnimationInterface anim("RIPAnim.xml");
	
	//Nodes
 	anim.SetConstantPosition(nodes.Get(0),25.0,150.0);//SRC
	anim.SetConstantPosition(nodes.Get(1),50.0,0.0);//Destionation
	
  //Routers
  anim.SetConstantPosition(routers.Get(0),25.0,100.0);//A
 	anim.SetConstantPosition(routers.Get(1),75.0,100.0);//B
	anim.SetConstantPosition(routers.Get(2),50.0,50.0);//C
	anim.SetConstantPosition(routers.Get(3),50.0,10.0);//D
